...
export default function AssignmentCard({ assignment, onDelete }: Props) {
  ...
  return (
    <div className="group bg-white dark:bg-app-surface rounded-2xl p-5 shadow-[0_1px_3px_rgba(16,24,40,0.06),0_4px_16px_rgba(16,24,40,0.08),0_14px_36px_-6px_rgba(16,24,40,0.06)] hover:shadow-[0_2px_6px_rgba(16,24,40,0.08),0_8px_28px_rgba(16,24,40,0.12),0_22px_48px_-8px_rgba(16,24,40,0.08)] hover:-translate-y-0.5 dark:shadow-[0_2px_8px_rgba(0,0,0,0.22),0_8px_24px_rgba(0,0,0,0.30)] dark:hover:shadow-[0_4px_16px_rgba(0,0,0,0.34),0_16px_40px_rgba(0,0,0,0.46)] transition-[box-shadow,transform] duration-200 flex flex-col gap-3 animate-fade-in">
